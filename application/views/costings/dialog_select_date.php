    ...
    <div class="row mb-3">
        <div class="col-md-12 mb-2">
            <label class="form-label d-block">
                <?php echo $this->lang->line('report_type'); ?>
            </label>
            <div class="form-check-inline">
                <input class="form-check-input" style="margin-top:0px !important; margin-right:1px !important;" id="expense_report" type="radio" name="report_type" value="1" checked />
                <label for="expense_report"><?php echo $this->lang->line('expense_report_type'); ?></label>
            </div>
            <div class="form-check-inline">
                <input class="form-check-input" style="margin-top:0px !important; margin-right:1px !important;" id="nominal_report" type="radio" name="report_type" value="2" />
                <label for="nominal_report"><?php echo $this->lang->line('nominal_report_type'); ?></label>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btn_generate_report").click(function() {
            ...
            fd.append("reportType", document.querySelector("input[name='report_type']:checked").value);
            ...
            $.ajax({
                type: "POST",
                url: base_url + "/generate_summary_report",
                data: fd,
                contentType: false,
                cache: false,
                processData: false,
