...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-sm btn-success mb-1" name="btn_generate_acpm" id="btn_generate_acpm"><?php echo $this->lang->line("generate"); ?></button>
</div>
<?php echo form_close(); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btn_generate_acpm").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "/generate_acpm_report",
                data: fd,
                contentType: false,
                cache: false,
                processData: false,
