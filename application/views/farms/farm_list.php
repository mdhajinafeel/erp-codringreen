...
<div class="card mb-3">
	<div class="card-header table-responsive">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h3> <?php echo $this->lang->line('farm_title'); ?> </h3>
			</div>
			<div class="col-auto ms-auto">
				<button class="btn btn-success btn-md" title="<?php echo $this->lang->line('new'); ?>" type="button" id="btn_new_farm">
	...
	<div class="card-body pt-0">
		...
		<table class="datatables-demo table table-striped table-bordered" id="xin_table_farms" style="width: 100% !important;">
