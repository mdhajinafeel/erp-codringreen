				...
				<div class="collapse navbar-collapse" id="navbarVerticalCollapse">
					<div class="navbar-vertical-content scrollbar">
						<ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
							...
							<?php if (in_array('1', $role_resources_ids) || in_array('2', $role_resources_ids) || in_array('3', $role_resources_ids) || in_array('8', $role_resources_ids)) { ?>
								...
								<li class="nav-item">
									...
									<?php if (in_array('1', $role_resources_ids)) { ?>
										<a class="nav-link <?php if ($this->router->fetch_class() == "traderinvoice") {
																echo 'active';
															} else {
																'';
															} ?>" href="<?php echo site_url('traderinvoice'); ?>" role="button" aria-expanded="false">
											<div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-file-invoice-dollar"></span></span><span class="nav-link-text ps-1"><?php echo $this->lang->line('trader_invoice'); ?></span>
											</div>
										</a>
									<?php } ?>
							...
							<?php if (in_array('1', $role_resources_ids) || in_array('2', $role_resources_ids) || in_array('3', $role_resources_ids) || in_array('4', $role_resources_ids)) { ?>
								<li class="nav-item">
									<div class="row navbar-vertical-label-wrapper mt-3 mb-2">
									...
									<?php if (in_array('1', $role_resources_ids) || in_array('2', $role_resources_ids) || in_array('3', $role_resources_ids) || in_array('4', $role_resources_ids)) { ?>
										...
										<ul class="nav collapse <?php if ($this->router->fetch_class() == "supplierledger" || $this->router->fetch_class() == "purchasemanagerledger"  || $this->router->fetch_class() == "buyerledger") {
																	echo 'show';
																} else {
																	'false';
																} ?>" id="contractledger">
											...
											<?php } ?>
											<li class="nav-item">
												<a class="nav-link <?php if ($this->router->fetch_class() == "buyerledger") {
																		echo 'active';
																	} else {
																		'';
																	} ?>" href="<?php echo site_url('buyerledger'); ?>" aria-expanded="false">
													<div class="d-flex align-items-center"><span class="nav-link-text ps-1"><?php echo $this->lang->line('buyer_title'); ?></span>
													</div>
												</a>
											</li>
										</ul>
									...
									<?php if (in_array('1', $role_resources_ids) || in_array('2', $role_resources_ids) || in_array('4', $role_resources_ids)) { ?>
										...
										<ul class="nav collapse <?php if ($this->router->fetch_class() == "liquidationreport" || $this->router->fetch_class() == "costsummaryreport" || $this->router->fetch_class() == "stockreport") {
											...
											<?php if (in_array('1', $role_resources_ids)) { ?>
												<li class="nav-item">
													<a class="nav-link <?php if ($this->router->fetch_class() == "consolidatedfarmreport") {
																			echo 'active';
																		} else {
																			'';
																		} ?>" href="<?php echo site_url('consolidatedfarmreport'); ?>" aria-expanded="false">
														<div class="d-flex align-items-center"><span class="nav-link-text ps-1"><?php echo $this->lang->line('consolidatedfarmreport'); ?></span>
														</div>
													</a>
												</li>
											<?php } ?>
											...
											<?php if (in_array('1', $role_resources_ids)) { ?>
												<li class="nav-item">
													<a class="nav-link <?php if ($this->router->fetch_class() == "gcreport") {
																			echo 'active';
																		} else {
																			'';
																		} ?>" href="<?php echo site_url('gcreport'); ?>" aria-expanded="false">
														<div class="d-flex align-items-center"><span class="nav-link-text ps-1"><?php echo $this->lang->line('gcreport'); ?></span>
														</div>
													</a>
												</li>
											<?php } ?>
