	...
	<div class="card-header table-responsive">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h3> <?php echo $this->lang->line('product_title'); ?> </h3>
			</div>
	...
	<div class="card-body pt-0">
		...
		<div class="row mb-5">
			<div class="col-md-4 align-self-center">
				<label for="origin_product"><?php echo $this->lang->line("origin"); ?></label>
				<select class="form-control" name="origin_product" id="origin_product" data-plugin="select_erp">
		...
		<table class="datatables-demo table table-striped table-bordered" id="xin_table" style="width: 100% !important;">
			<thead>
				<tr>
					...
					<th><?php echo $this->lang->line('product_desc'); ?></th>
					<th><?php echo $this->lang->line('product_icon'); ?></th>
