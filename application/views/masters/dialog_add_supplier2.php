	...
	<div class="row">
		<div class="col-md-12">
			...
			<div id="idSupplierTaxes">
				...
				<div class="form-group row">
					<div class="col-md-3">
						<div class="input-group">
							<div class="form-check">
								<input class="form-check-input" id="checksupplieriva" name="checksupplieriva" type="checkbox" value="1">
								<label for="checksupplieriva"><?php echo $this->lang->line('iva'); ?></label>
							</div>
							<div class="input-group">
								<input name="supplieriva" type="number" step="any" maxlength="8" id="supplieriva" autocomplete="off" class="form-control" />
							</div>
							<label id="error-supplieriva" class="error-text"><?php echo $this->lang->line('error_value'); ?></label>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="input-group">
							<div class="form-check">
								<input class="form-check-input" id="checksupplierretention" name="checksupplierretention" type="checkbox" value="1">
								<label for="checksupplierretention"><?php echo $this->lang->line('retention'); ?></label>
							</div>
							<div class="input-group">
								<input name="supplierretention" type="number" step="any" maxlength="8" id="supplierretention" autocomplete="off" class="form-control" />
							</div>
							<label id="error-supplierretention" class="error-text"><?php echo $this->lang->line('error_value'); ?></label>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="input-group">
							<div class="form-check">
								<input class="form-check-input" id="checksupplierretica" name="checksupplierretica" type="checkbox" value="1">
								<label for="checksupplierretica"><?php echo $this->lang->line('reteica'); ?></label>
							</div>
							<div class="input-group">
								<input name="supplierretica" type="number" step="any" maxlength="8" id="supplierretica" autocomplete="off" class="form-control" />
							</div>
							<label id="error-supplierretica" class="error-text"><?php echo $this->lang->line('error_value'); ?></label>
						</div>
					</div>
				</div>
			</div>
			...
			<?php if ($pagetype == "edit") {
				...
				if ($is_retencion_enabled == true) {
					echo '$("#checksupplierretention").attr("checked", "checked");';
					echo '$("#supplierretention").removeAttr("disabled");';
					echo '$("#supplierretention").val(' . $retencion_value . ');';
				} else {
					echo '$("#supplierretention").attr("disabled", "disabled");';
					echo '$("#supplierretention").val("");';
				}

				if ($is_reteica_enabled == true) {
					echo '$("#checksupplierretica").attr("checked", "checked");';
					echo '$("#supplierretica").removeAttr("disabled");';
					echo '$("#supplierretica").val(' . $reteica_value . ');';
				} else {
					echo '$("#supplierretica").attr("disabled", "disabled");';
					echo '$("#supplierretica").val("");';
				}
			...
			<div id="idProviderTaxes">
				...
				<div class="form-group row">
					<div class="col-md-3">
						<div class="input-group">
							<div class="form-check">
								<input class="form-check-input" id="checkprovideriva" name="checkprovideriva" type="checkbox" value="1">
								<label for="checkprovideriva"><?php echo $this->lang->line('iva'); ?></label>
							</div>
							<div class="input-group">
								<input name="provideriva" type="number" step="any" maxlength="8" id="provideriva" autocomplete="off" class="form-control" />
							</div>
							<label id="error-provideriva" class="error-text"><?php echo $this->lang->line('error_value'); ?></label>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="input-group">
							<div class="form-check">
								<input class="form-check-input" id="checkproviderretention" name="checkproviderretention" type="checkbox" value="1">
								<label for="checkproviderretention"><?php echo $this->lang->line('retention'); ?></label>
							</div>
							<div class="input-group">
								<input name="providerretention" type="number" step="any" maxlength="8" id="providerretention" autocomplete="off" class="form-control" />
							</div>
							<label id="error-providerretention" class="error-text"><?php echo $this->lang->line('error_value'); ?></label>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="input-group">
							<div class="form-check">
								<input class="form-check-input" id="checkproviderretica" name="checkproviderretica" type="checkbox" value="1">
								<label for="checkproviderretica"><?php echo $this->lang->line('reteica'); ?></label>
							</div>
							<div class="input-group">
								<input name="providerretica" type="number" step="any" maxlength="8" id="providerretica" autocomplete="off" class="form-control" />
							</div>
							<label id="error-providerretica" class="error-text"><?php echo $this->lang->line('error_value'); ?></label>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#add_product_fields').click(function() {
			...
			productfields = '<tr class="DataRow" id="row_product' + j + '">';
					...
					if (isValid5) {
						...
						if (isValid6 == false && isValid7 == false) {
							...
							if ($("#enablesupplierrole").prop('checked') == true) {
								...
								if ($("#checksupplieriva").prop('checked') == true) {
									supplierIvaEnabled = 1;
									if (supplieriva.length == 0) {
										$("#error-supplieriva").text(error_value);
										$("#error-supplieriva").show();
										$("#supplieriva").focus();
										isValid8 = false;
										supplierIvaValue = 0;
									} else {
										if (supplieriva == 0) {
											$("#error-supplieriva").text(error_zero_value);
											$("#error-supplieriva").show();
											supplierIvaValue = 0;
											isValid8 = false;
										} else {
											$("#error-supplieriva").hide();
											supplierIvaValue = supplieriva;
											isValid8 = true;
										}
									}
								} else {
									supplierIvaEnabled = 0;
									supplierIvaValue = 0;
								}

								if ($("#checksupplierretention").prop('checked') == true) {
									supplierRetentionEnabled = 1;
									if (supplierretention.length == 0) {
										$("#error-supplierretention").text(error_value);
										$("#error-supplierretention").show();
										$("#supplierretention").focus();
										isValid9 = false;
										supplierRetentionValue = 0;
									} else {
										if (supplierretention == 0) {
											$("#error-supplierretention").text(error_zero_value);
											$("#error-supplierretention").show();
											supplierRetentionValue = 0;
											isValid9 = false;
										} else {
											$("#error-supplierretention").hide();
											supplierRetentionValue = supplierretention;
											isValid9 = true;
										}
									}
								} else {
									supplierRetentionEnabled = 0;
									supplierRetentionValue = 0;
								}

								if ($("#checksupplierretica").prop('checked') == true) {
									supplierReticaEnabled = 1;
									if (supplierretica.length == 0) {
										$("#error-supplierretica").text(error_value);
										$("#error-supplierretica").show();
										$("#supplierretica").focus();
										isValid10 = false;
										supplierReticaValue = 0;
									} else {
										if (supplierretica == 0) {
											$("#error-supplierretica").text(error_zero_value);
											$("#error-supplierretica").show();
											supplierReticaValue = 0;
											isValid10 = false;
										} else {
											$("#error-supplierretica").hide();
											supplierReticaValue = supplierretica;
											isValid10 = true;
										}
									}
								} else {
									supplierReticaEnabled = 0;
									supplierReticaValue = 0;
								}
							} else {
							...
							if ($("#enableproviderrole").prop('checked') == true) {
								...
								if ($("#checkprovideriva").prop('checked') == true) {
									providerIvaEnabled = 1;
									if (provideriva.length == 0) {
										$("#error-provideriva").text(error_value);
										$("#error-provideriva").show();
										$("#provideriva").focus();
										isValid11 = false;
										providerIvaValue = 0;
									} else {
										if (provideriva == 0) {
											$("#error-provideriva").text(error_zero_value);
											$("#error-provideriva").show();
											providerIvaValue = 0;
											isValid11 = false;
										} else {
											$("#error-provideriva").hide();
											providerIvaValue = provideriva;
											isValid11 = true;
										}
									}
								} else {
									providerIvaEnabled = 0;
									providerIvaValue = 0;
								}

								if ($("#checkproviderretention").prop('checked') == true) {
									$providerRetentionEnabled = 1;
									if (providerretention.length == 0) {
										$("#error-providerretention").text(error_value);
										$("#error-providerretention").show();
										$("#providerretention").focus();
										isValid12 = false;
										providerRetentionValue = 0;
									} else {
										if (providerretention == 0) {
											$("#error-providerretention").text(error_zero_value);
											$("#error-providerretention").show();
											providerRetentionValue = 0;
											isValid12 = false;
										} else {
											$("#error-providerretention").hide();
											providerRetentionValue = providerretention;
											isValid12 = true;
										}
									}
								} else {
									providerRetentionEnabled = 0;
									providerRetentionValue = 0;
								}

								if ($("#checkproviderretica").prop('checked') == true) {
									providerReticaEnabled = 1;
									if (providerretica.length == 0) {
										$("#error-providerretica").text(error_value);
										$("#error-providerretica").show();
										$("#providerretica").focus();
										isValid13 = false;
										providerReticaValue = 0;
									} else {
										if (providerretica == 0) {
											$("#error-providerretica").text(error_zero_value);
											$("#error-providerretica").show();
											$roviderReticaValue = 0;
											isValid13 = false;
										} else {
											$("#error-providerretica").hide();
											providerReticaValue = providerretica;
											isValid13 = true;
										}
									}
								} else {
									providerReticaEnabled = 0;
									providerReticaValue = 0;
								}
							} else {
		...
		$.ajax({
				...
				success: function(JSON) {
					...
					if (JSON.redirect == true) {
						...
						productfields = "";
						$("#product_fields tr[id*=row_product]").detach();
					}
				}
			});
	}
