	...
	<div class="card-header table-responsive">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h3> <?php echo $this->lang->line('machine_title'); ?> </h3>
			</div>
			<div class="col-auto ms-auto">
				<button class="btn btn-success btn-md" type="button" id="btn_new_machine">
	...
	<div class="card-body pt-0">
		...
		<div class="row mb-5">
			<div class="col-md-4 align-self-center">
				<label for="origin_machine"><?php echo $this->lang->line("origin"); ?></label>
				<select class="form-control" name="origin_machine" id="origin_machine" data-plugin="select_erp">
		...
		<table class="datatables-demo table table-striped table-bordered" id="xin_table_machines" style="width: 100% !important;">
			<thead>
				<tr>
					<th><?php echo $this->lang->line('action'); ?></th>
					<th><?php echo $this->lang->line('machine_name'); ?></th>
					<th><?php echo $this->lang->line('chassis_model'); ?></th>
