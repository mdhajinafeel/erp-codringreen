		...
		<div class="row g-3 mb-3">
			...
			<div class="col-md-3">
				<div class="card overflow-hidden" style="min-width: 12rem">
					...
					<div class="card-body position-relative">
						<h4><?php echo $this->lang->line('cost_per_cbm'); ?></h4>
					...
					<div class="card-body">
						<div class="tab-content">
							<div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-7106f20c-f055-4653-ab49-9867db7fd49f" id="dom-7106f20c-f055-4653-ab49-9867db7fd49f">
								<div class="echart-basic-bar" style="min-height: 300px;" data-echart-responsive="true"></div>
							</div>
						</div>
					</div>
				</div>
	...
	var summaryDataInit = function summaryDataInit() {
			$.ajax({
				...
				success: function(response) {
					...
					$("#total_bins").text(response.totalBins);
				},
				error: function() {
