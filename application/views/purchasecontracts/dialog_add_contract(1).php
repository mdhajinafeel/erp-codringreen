...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#product_type").change(function() {
            ...
            if ($("#product_type").val() == 0) {
                ...
                fetchMeasurementSystem($("#product_type").val());
                showPrices($("#product_type").val());
                $("#error-woodtype").hide();
                $("#divManualEntry").show();
                $("#divExcelUpload").hide();
            }
    ...
    function fetchMeasurementSystem(producttypeid) {
        $("#loading").show();
        $.ajax({
            url: base_url + "/get_measurement_system?producttypeid=" + producttypeid,
            cache: false,
            method: "GET",
            dataType: 'json',
            success: function(JSON) {
    ...
    function showPrices(producttypeid) {
