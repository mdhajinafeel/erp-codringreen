...
<div class="modal-body">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<label class="head-label"><?php echo $this->lang->line('description'); ?></label>
			<div class="input-group">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="row mb-2">
				...
				if ($product == 4 &&  ($product_type == 1 || $product_type == 3)) { ?>
					<div class="col-md-2">
				...
				<?php } else if ($product_type == 1 || $product_type == 3) { ?>
					<div class="col-md-2">
			...
			<?php foreach ($contract_price as $price) { ?>
				<div class="row">
					<?php if ($product == 4 && ($product_type == 1 || $product_type == 3)) { ?>
						<div class="col-md-2">
							<label class="col-form-label"><?php echo $price->minrange_grade1 + 0; /*$fmt->format(($price->minrange_grade1 + 0));*/ ?></label>
						</div>
						<div class="col-md-2">
							<label class="col-form-label"><?php echo $price->maxrange_grade2 + 0; /*$fmt->format(($price->maxrange_grade2 + 0));*/ ?></label>
						</div>
					<?php } else if ($product_type == 1 || $product_type == 3) { ?>
						<div class="col-md-2">
					...
					<div class="col-md-2">
						<label class="col-form-label"><?php echo $fmt->format(($price->pricerange_grade_semi + 0)); ?></label>
					</div>
					<div class="col-md-2">
						<label class="col-form-label"><?php echo $fmt->format(($price->pricerange_grade_longs + 0)); ?></label>
					</div>
				</div>
			<?php } ?>
		</div>
