...
<div class="card mb-3">
	<div class="card-header table-responsive">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h3> <?php echo $this->lang->line('contracts_title'); ?> </h3>
			</div>
			<div class="col-auto ms-auto">
				<button class="btn btn-primary btn-md btn-right-margin" title="<?php echo $this->lang->line('download_contracts'); ?>" type="button" id="generate_report">
					<span class="fas fa-download" data-fa-transform="shrink-3 down-2"></span><span class="ms-1">
						<?php echo $this->lang->line('download_contracts'); ?></span>
					</button>
				<button class="btn btn-success btn-md" title="<?php echo $this->lang->line('new'); ?>" type="button" id="btn_new_contract">
	...
	<div class="card-body pt-0">
		...
		<table class="datatables-demo table table-striped table-bordered" id="xin_table_contracts" style="width: 100% !important;">
