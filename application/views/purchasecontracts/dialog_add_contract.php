                    ...
                    <?php foreach ($contractprice as $price) { ?>
                        ...
                        <?php if ($j == 1) { ?>
                            <div class="row DataRow">
                                ...
                                <div class="col-md-2">
                                    <input type="number" id="price_range" placeholder="<?php echo $this->lang->line('range_price_shorts'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" step="any" value="<?php echo ($price->pricerange_grade3 + 0); ?>">
                                </div>

                                <div class="col-md-2">
                                    <input type="number" id="price_range_semi" placeholder="<?php echo $this->lang->line('range_price_semi'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range_semi" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" step="any" value="<?php echo ($price->pricerange_grade_semi + 0); ?>">
                                </div>

                                <div class="col-md-2">
                                    <input type="number" id="price_range_longs" placeholder="<?php echo $this->lang->line('range_price_longs'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range_longs" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" step="any" value="<?php echo ($price->pricerange_grade_longs + 0); ?>">
                                </div>
                ...
                <div class="row" id="divExcelUpload">
                    ...
                    <div id="divRoundLogPrice">
                        <div class="row mt-3 mb-2">
                            ...
                            <div class="col-md-2">
                                <label class="col-form-label font-template-heading text-decoration-underline"><?php echo $this->lang->line('range_price_shorts'); ?></label>
                            </div>
                            <div class="col-md-2">
                                <label class="col-form-label font-template-heading text-decoration-underline"><?php echo $this->lang->line('range_price_semi'); ?></label>
                            </div>
                            <div class="col-md-2">
                                <label class="col-form-label font-template-heading text-decoration-underline"><?php echo $this->lang->line('range_price_longs'); ?></label>
                            </div>
                        </div>
                        <div id="divPriceFields">
                            <div class="row DataRow">
                                ...
                                <div class="col-md-2">
                                    <label class="col-form-label" id="priceRangeUploadShorts" name="priceRangeUploadShorts"></label>
                                </div>
                                <div class="col-md-2">
                                    <label class="col-form-label" id="priceRangeUploadSemi" name="priceRangeUploadSemi"></label>
                                </div>
                                <div class="col-md-2">
                                    <label class="col-form-label" id="priceRangeUploadLongs" name="priceRangeUploadLongs"></label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div id="divManualEntry">
                    ...
                    <div class="row DataRow">
                        ...
                        <div class="col-md-2">
                            <input type="number" id="price_range" placeholder="<?php echo $this->lang->line('range_price_shorts'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                        </div>

                        <div class="col-md-2">
                            <input type="number" id="price_range_semi" placeholder="<?php echo $this->lang->line('range_price_semi'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range_semi" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                        </div>

                        <div class="col-md-2">
                            <input type="number" id="price_range_longs" placeholder="<?php echo $this->lang->line('range_price_longs'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range_longs" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#add_price').click(function() {
            ...
            if (isValid) {
                ...
                pricefields = pricefields + '<div class="col-md-2">';
                ...
                pricefields = pricefields + '</div>';
                pricefields = pricefields + '<div class="col-md-2">';
                pricefields = pricefields + '<input type="number" id="price_range" placeholder="<?php echo $this->lang->line('range_price_shorts'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">';
                pricefields = pricefields + '</div>';
                pricefields = pricefields + '<div class="col-md-2">';
                pricefields = pricefields + '<input type="number" id="price_range_semi" placeholder="<?php echo $this->lang->line('range_price_semi'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range_semi" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">';
                pricefields = pricefields + '</div>';
                pricefields = pricefields + '<div class="col-md-2">';
                pricefields = pricefields + '<input type="number" id="price_range_longs" placeholder="<?php echo $this->lang->line('range_price_longs'); ?>" min="0" maxlength="10" onkeypress="return isNumberKey(this, event)" name="price_range_longs" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">';
                pricefields = pricefields + '</div>';
                pricefields = pricefields + '<div class="col-md-2">';
                ...
                if (JSON.redirect == true) {
                    ...
                    if (price_array.length > 0) {
                        ...
                        for (var counter in price_array) {
                            priceuploaddata = "";
                            priceuploaddata = priceuploaddata + "<div class='row DataRow'><div class='col-md-2'>";
                            ...
                            priceuploaddata = priceuploaddata + "<div class='col-md-2'>";
                            ...
                            priceuploaddata = priceuploaddata + "</div>";
                            priceuploaddata = priceuploaddata + "<div class='col-md-2'>";
                            priceuploaddata = priceuploaddata + "<label class='col-form-label' id='priceRangeUploadShorts' name='priceRangeUploadShorts'>" + price_array[counter].priceShorts + "</label>";
                            priceuploaddata = priceuploaddata + "</div>";
                            priceuploaddata = priceuploaddata + "<div class='col-md-2'>";
                            priceuploaddata = priceuploaddata + "<label class='col-form-label' id='priceRangeUploadSemi' name='priceRangeUploadSemi'>" + price_array[counter].priceSemi + "</label>";
                            priceuploaddata = priceuploaddata + "</div>";
                            priceuploaddata = priceuploaddata + "<div class='col-md-2'>";
                            priceuploaddata = priceuploaddata + "<label class='col-form-label' id='priceRangeUploadLongs' name='priceRangeUploadLongs'>" + price_array[counter].priceLongs + "</label>";
