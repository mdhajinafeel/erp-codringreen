                            ...
                            <div id="divContainersShipping">
                                ...
                                <?php foreach ($containerDetails as $containerdetail) { ?>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <?php $containerShippingValue = 0; foreach($exportDocumentsShippingContainers as $shippingcontainers) { ?>
                                            <?php if($portcontainers->dispatch_id == $containerdetail->dispatch_id) { $containerShippingValue = $portcontainers->container_value + 0; break;  } ?>
                                        <?php } ?>
