    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6" id="divUploadedDetails">
            <div class="next-line">
                ...
                <label class="label-showdetails" for="lblGrossVolume" id="lblGrossVolume"><?php echo $this->lang->line("total_gross_volume") . ": "; ?><?php echo $export_details[0]->total_gross_volume + 0; ?></label>
                <label class="label-showdetails" for="lblNetVolume" id="lblNetVolume"><?php echo $this->lang->line("total_net_volume") . ": "; ?><?php echo $export_details[0]->total_net_volume + 0; ?></label>
                <label class="label-showdetails" for="lblNetWeight" id="lblNetWeight"><?php echo $this->lang->line("total_net_weight") . ": "; ?><?php echo $export_details[0]->total_net_weight + 0; ?></label>
            </div>
        </div>
    </div>
    ...
    <?php if ($originid == 3) { ?>
        <div class="row" style="margin-bottom: 30px;">
            ...
            <div class="col-md-6 mb-2">
                ...
                <input type="text" id="notify_name" name="notify_name" class="form-control text-uppercase" value="<?php echo $export_details[0]->notify_name; ?>" />
            </div>
            <div class="col-md-6 mb-2">
                <label for="notify_details"><?php echo $this->lang->line("details"); ?></label>
                <textarea name="notify_details" id="notify_details" maxlength="400" rows="6" class="form-control"><?php echo $export_details[0]->notify_details; ?></textarea>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 30px;">
            ...
            <div class="col-md-6 mb-2">
                ...
                <input type="text" id="consignee_name" name="consignee_name" class="form-control text-uppercase" value="<?php echo $export_details[0]->consignee_name; ?>" />
            </div>
            <div class="col-md-6 mb-2">
                <label for="consignee_details"><?php echo $this->lang->line("details"); ?></label>
                <textarea name="consignee_details" id="consignee_details" maxlength="400" rows="6" class="form-control"><?php echo $export_details[0]->consignee_details; ?></textarea>
            </div>
        </div>
    <?php } ?>
</div>
...
<script type="text/javascript">
    ...
    var totalNetWeight = <?php echo $export_details[0]->total_net_weight; ?>;
