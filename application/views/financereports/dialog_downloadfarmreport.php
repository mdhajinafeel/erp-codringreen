...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-sm btn-success mb-1" name="btn_download_farmreport" id="btn_download_farmreport"><?php echo $this->lang->line("download"); ?></button>
</div>
<?php echo form_close(); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btn_download_farmreport").click(function() {
            ...
            if (isValid1 && isValid2) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "/download_farm_report_bulk",
                    data: fd,
                    contentType: false,
                    cache: false,
                    processData: false,
