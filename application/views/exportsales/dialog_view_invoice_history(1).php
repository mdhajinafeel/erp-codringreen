                                    ...
                                    <button class="accordion-button collapsed" style="display: inline-grid !important;" type="button" data-bs-toggle="collapse" data-bs-target="#invoice_<?php echo $invoice->id; ?>" aria-expanded="true" aria-controls="collapse1">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                ...
                                                <div class="input-group">
                                                    <label class="control-label"><?php echo "$" . round($invoice->total_invoice_value, 2); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </button>
                                ...
                                <div class="accordion-collapse collapse" id="invoice_<?php echo $invoice->id; ?>" aria-labelledby="heading1" data-bs-parent="#accordionExample" style="padding: 20px;">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->shorts_base_price, 2); ?></label>
                                            </div>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->semi_base_price, 2); ?></label>
                                            </div>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->long_base_price, 2); ?></label>
                                            </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo round($invoice->service_sales_percentage, 2) . "%"; ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->total_service_cost, 2); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->advance_cost, 2); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->total_advance_cost, 2); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <div class="input-group">
                                                <label class="control-label"><?php echo "$" . round($invoice->claim_amount, 2); ?></label>
                                            </div>
                                        </div>
