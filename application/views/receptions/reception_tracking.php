...
<div class="card mb-3">
	<div class="card-header table-responsive">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h3> <?php echo $this->lang->line("viewtracking_title") . " - " . $this->lang->line("reception_title"); ?> </h3>
			</div>
		</div>
	...
	<div class="card-body pt-0">
		...
		<table class="datatables-demo table table-striped table-bordered" id="xin_table_receptiontracking" style="width: 100% !important;">
			<thead>
				<tr>
