...
<div class="card mb-3">
    ...
    <div class="card-body pt-5">
        <div class="mb-3 row">
            ...
            <label class="col-sm-2 col-form-label lbl-font" for="beneficiary_name_ledger"><?php echo $this->lang->line('beneficiary_name'); ?></label>
            <div class="col-sm-10">
                <select class="form-control" name="beneficiary_name_ledger" id="beneficiary_name_ledger" data-plugin="select_erp">
                    <option value="0"><?php echo $this->lang->line('select'); ?></option>
                </select>
                <div class="mb-4 row"></div>
            </div>
...
<div class="card mb-3" id="divExpenseLedgers">
    <div class="card-body">
        <div class="row">
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse1">
                                    ...
                                    <table class="datatables-demo table table-responsive table-striped table-bordered" id="xin_table_debits" style="width: 100% !important;">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line("beneficiary_name"); ?></th>
                                                <th><?php echo $this->lang->line("last_updated_by"); ?></th>
                                            </tr>
                                        </thead>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#origin_ledger").change(function() {
            ...
            fetchExpenseLedgerUsers($("#origin_ledger").val());
        });

        $("#beneficiary_name_ledger").change(function() {
            ...
            $("#loading").show();
            $.ajax({
                url: base_url + "/get_ledger_details_by_user?originid=" + $("#origin_ledger").val() + "&userid=" + $("#beneficiary_name_ledger").val(),
                cache: false,
                method: "GET",
                dataType: "json",
