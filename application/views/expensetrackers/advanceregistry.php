...
<div class="card mb-3">
    ...
    <div class="card-body pt-5">
        <div class="mb-3 row">
            ...
            <label class="col-sm-2 col-form-label lbl-font" for="beneficiary_name"><?php echo $this->lang->line('beneficiary_name'); ?></label>
            <div class="col-sm-10">
                <select class="form-control" name="beneficiary_name" id="beneficiary_name" data-plugin="select_erp">
                    <option value="0"><?php echo $this->lang->line('select'); ?></option>
                </select>
    ...
    $(document).ready(function() {
        ...
        $("#btn_new_registry").click(function() {
            ...
            if (isValid1 && isValid2 && isValid3 && isValid4 && isValid5) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "/save_advance_registry",
                    data: fd,
                    contentType: false,
                    cache: false,
                    processData: false,
        ...
        $.ajax({
            ...
            success: function(JSON) {
                ...
                if (JSON.redirect == true) {
                    ...
                    $("#beneficiary_name").empty();
                    $("#beneficiary_name").append(JSON.result);
                }
            }
        });
    }
