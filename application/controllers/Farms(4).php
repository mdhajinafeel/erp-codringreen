                            ...
                            foreach ($farmdataJson as $farm) {
                                ...
                                if ($totalCount > 0 && $metricTon > 0 && $jasVolume > 0 && count($farm["containerData"]) > 0) {
                                    ...
                                    $dataFarm = array(
                                        ...
                                        "total_volume" => $jasVolume, "total_value" => 0, "wood_value" => 0,
                    ...
                    if ($_FILES['fileFarmExcel']['size'] > 0) {
                        ...
                        if (!$this->upload->do_upload('fileFarmExcel')) {
                            ...
                            if ($arrayCount > 0) {
                                ...
                                $createArray = array('CONTAINER', 'SEAL', 'MT', 'SHORT TONS', 'NET LBS', 'DIAMETER', 'LENGTH');
                                $makeArray = array('CONTAINER' => 'CONTAINER', 'SEAL' => 'SEAL', 'MT' => 'MT', 'SHORTTONS' => 'SHORT TONS', 'NETLBS' => 'NET LBS', 'DIAMETER' => 'DIAMETER', 'LENGTH' => 'LENGTH');
                                $SheetDataKey = array();
                                        ...
                                        if (($containerVal != null && $containerVal != "") &&
                                            ...
                                            if ($objPHPExcel->sheetNameExists($containerVal)) {
                                                ...
                                                $farmData[] = array(
                                                    ...
                                                    'seal' => $sealVal,
                                                    'metricTon' => $metricTonVal + 0, //sprintf('%0.3f', $metricTonVal),
                                                ...
                                                $farmData[] = array(
                                                    'containerNumber' => $containerVal,
                                                    'seal' => $sealVal,
                                                    'metricTon' => sprintf('%0.3f', $metricTonVal),
                                                    'shortTons' => sprintf('%0.3f', $shortTonsVal),
                                                    'netLbs' => sprintf('%0.3f', $netLbsVal),
                                                    'diameter' => $diameterVal,
                                                    'length' => $lengthVal,
