            ...
            if (!empty($session)) {
                ...
                if (count($exportOrderDetail) == 1) {
                    ...
                    if ($originId == 3) {
                        ...
                        $objSheet->getStyle("A17:H17")->getFont()->setBold(true);
                        $objSheet->getStyle("A17:H17")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("C4D79B");
                        $objSheet->getStyle("A17:H17")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        $objSheet->getStyle("A17:H17")->applyFromArray($styleArray);
                        ...
                        $objSheet->getStyle("A18:H$lastRowSummary")->applyFromArray($styleArray);
                        $objSheet->getStyle("A18:H$lastRowSummary")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        ...
                        $objSheet->getStyle("A$summaryDataCount:H$summaryDataCount")->getFont()->setBold(true);
                        $objSheet->getStyle("A$summaryDataCount:H$summaryDataCount")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("C4D79B");
                        $objSheet->getStyle("A$summaryDataCount:H$summaryDataCount")->applyFromArray($styleArray);
                        ...
                        $objSheet->getStyle("A$summaryDataCount:H$summaryDataCount")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
