                        ...
                        if ($checkWarehouse[0]->cnt == 1) {
                            ...
                            if ($checkShippingLine[0]->cnt == 1) {
                                ...
                                if ($productType[0]->product_type_id == 1 || $productType[0]->product_type_id == 3) {
                                    ...
                                    $objSheet->getStyle("A17:J17")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("238923");
                                    ...
                                    if (count($getContainerDetails) > 0) {
                                        foreach ($getContainerDetails as $containerdetails) {
                                            ...
                                            $objWorkSheet->getStyle("A15:E15")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('238923');
                                ...
                                $objSheet->getStyle("A$summaryDataCount:J$summaryDataCount")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("238923");
