        ...
        try {
            ...
            if (!empty($session)) {
                ...
                if ($originId == 3) {
                    ...
                    $objSheet->setCellValue("D35", "=SUM(D20:D34)");
                    $objSheet->setCellValue("G35", "=SUM(G20:G34)");
                    ...
                    $excelInvoiceValue = sprintf("%.2f", $objSheet->getCell('G35')->getCalculatedValue());
                    $excelVolumeValue = round($objSheet->getCell('D35')->getCalculatedValue(), 3);
                    $excelInvoicePrice = $objSheet->getCell('F35')->getCalculatedValue();
