                    ...
                    if ($checkUserExists == true) {
                        ...
                        if (count($receptionData) > 0) {
                            foreach ($receptionData as $key => $value) {
                                ...
                                if ($receptionId > 0 && $inventoryOrder != null && $inventoryOrder != "") {
                                    

                                    $getReceptionDetailsById = $this->Reception_model->get_reception_detail_by_id_app($receptionId);
                                    ...
                                    if (count($getReceptionDetailsById) == 1) {
                                        ...
                                        $updateDataReception = array(
                                            ...
                                            "total_volume" => $totalVolume, "total_pieces" => $totalPieces,
                                        ...
                                        $updateReception = $this->Reception_model->update_reception_app($receptionId, $updateDataReception);
                                        ...
                                        if ($updateReception == true) {
                                                ...
                                                foreach ($receptionCaptured as $key => $capturevalue) {
                                                    ...
                                                    if ($receptionId > 0 && $receptionDataId > 0) {
                                                        ...
                                                        $updateDataCaputureReception = array(
                                                            ...
                                                            "cbm_export" => $netVolume, "updatedby" => $createdBy, "isactive" => $isActive,
                                                        );

                                                        $updateReceptionData = $this->Reception_model->update_reception_data_dataid($receptionId, $receptionDataId, $updateDataCaputureReception);
                                                        ...
                                                        if ($updateReceptionData == true) {
                                                            ...
                                                            if ($containerId > 0) {
                                                                ...
                                                                $updateDataCaputureDispatch = array(
                                                                    "cbm_bought" => $grossVolume, "cbm_export" => $netVolume, "updatedby" => $createdBy,
                                                                    "scanned_timestamp" => 0, "isduplicatescanned" => 0, "isactive" => $isActive, "dispatch_pieces" => $pieces
                                                                );

                                                                $updateDispatchCapure = $this->Dispatch_model->update_dispatch_data_by_id(
                                                                    $receptionDataId,
                                                                    $receptionId,
                                                                    $containerId,
                                                                ...
                                                                $insertDataCaputureDispatch = array(
                                                                    ...
                                                                    "cbm_bought" => $grossVolume, "cbm_export" => $netVolume, "createdby" => $createdBy, "updatedby" => $createdBy,
                                                            ...
                                                            $row_reception_data_array["receptionDataId"] = $receptionDataId;
                                                        ...
                                                        $insertDataCaputureReception = array(
                                                            ...
                                                            "scanned_code" => $pieces, "length_bought" => $lengthBought,
                                                            "circumference_bought" => $circumferenceBought, "cbm_bought" => $grossVolume,
                                                            "cbm_export" => $netVolume, "createdby" => $createdBy, "updatedby" => $createdBy, "isactive" => 1,
                                            ...
                                            if ($isClosed == true) {
                                                if ($isCreateFarm == true) {
                                                    $this->save_farm_from_reception($receptionId, $inventoryOrder);
                                                }
                                            }
                                            ...
                                            $row_reception_array["receptionId"] = $receptionId;
                                        ...
                                        $insertDataReception = array(
                                            ...
                                            "total_volume" => $totalVolume, "total_pieces" => $totalPieces, "captured_from_app" => 1, "is_create_farm" => $isCreateFarm,
                                            "contract_id" => $contractId, "truck_plate_number" => $truckPlateNumber,
                                        );
                                            ...
                                            if (count($receptionCaptured) > 0) {
                                                ...
                                                foreach ($receptionCaptured as $key => $capturevalue) {
                                                    ...
                                                    $insertDataCaputureReception = array(
                                                        ...
                                                        "scanned_code" => $pieces, "length_bought" => $lengthBought,
                                                        "circumference_bought" => $circumferenceBought, "cbm_bought" => $grossVolume,
                                                        "cbm_export" => $netVolume, "createdby" => $createdBy, "updatedby" => $createdBy, "isactive" => $isActive,
                                                        "isdispatch" => 1, "scanned_timestamp" => 0, "isduplicatescanned" => 0, "dispatch_date" => $receivedDate,
                                                        "container_number" => $containerNumber, "is_special" => 1, "remaining_stock_count" => 0
                                                    );
                    ...
                    if (count($getContractDetails) == 1) {
                        ...
                        if ($getInventoryOrderCount[0]->cnt == 0) {
                            ...
                            $dataFarm = array(
                                ...
                                "pay_service_to" => 0, "pay_logistics_to" => 0,
