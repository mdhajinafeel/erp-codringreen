                        ...
                        if ($getInventoryOrderCount[0]->cnt == 0) {
                            ...
                            if ($productid == 4 && ($producttypeid == 1 || $producttypeid == 3)) {
                                ...
                                foreach ($farmdataJson as $farm) {
                                    ...
                                    } else if ($purchaseunit == 8 || $purchaseunit == 9 || $purchaseunit == 12) {
                                ...
                                if ($purchaseunit == 8 || $purchaseunit == 9 || $purchaseunit == 12) {
            ...
            if (!empty($session)) {
                ...
                if (count($getFarmDetails) == 1 && count($getFarmDataDetails) > 0) {
                    ...
                    if (
                        ...
                        || $getFarmDetails[0]->unit_of_purchase == 8 || $getFarmDetails[0]->unit_of_purchase == 9 || $getFarmDetails[0]->unit_of_purchase == 12
                    ) {
                        ...
                        if ($getFarmDetails[0]->unit_of_purchase == 8 || $getFarmDetails[0]->unit_of_purchase == 9 || $getFarmDetails[0]->unit_of_purchase == 12) {
                        ...
                        if (count($getFarmDataSummary) > 0) {
                            ...
                            if ($getFarmDetails[0]->unit_of_purchase == 4 || $getFarmDetails[0]->unit_of_purchase == 5 || $getFarmDetails[0]->unit_of_purchase == 9 || $getFarmDetails[0]->unit_of_purchase == 12) {
                            ...
                            foreach ($getFarmDataSummary as $farmdatasummary) {
                                ...
                                if (count($return_arr_farmdata) > 0) {
                                    ...
                                    } else if ($getFarmDetails[0]->unit_of_purchase == 9 || $getFarmDetails[0]->unit_of_purchase == 12) {
                                        $objSheet->SetCellValue("H$rowCountDataSummary", "=IF(" . '$D$' . "$summaryHeaderLastRow" . ">=F$rowCountDataSummary,IF(" . '$D$' . "$summaryHeaderLastRow" . "<=G$rowCountDataSummary," . '$D$' . "3,0),0)");
                                    } else {
                                ...
                                } else if ($getFarmDetails[0]->unit_of_purchase == 6 || $getFarmDetails[0]->unit_of_purchase == 7 || $getFarmDetails[0]->unit_of_purchase == 9 || $getFarmDetails[0]->unit_of_purchase == 12) {
