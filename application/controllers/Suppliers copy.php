		...
		if ($this->input->get('type') == "addsupplier") {
			if (!empty($session)) {
				$data = array(
					...
					'is_iva_enabled' => false,
					'iva_value' => "",
					'is_retencion_enabled' => false,
					'retencion_value' => "",
					'is_reteica_enabled' => false,
					'reteica_value' => "",
					'is_iva_provider_enabled' => false,
					'iva_provider_value' => "",
					'is_retencion_provider_enabled' => false,
					'retencion_provider_value' => "",
					'is_reteica_provider_enabled' => false,
					'reteica_provider_value' => "",
				);
			...
			if (!empty($session)) {
				...
				$data = array(
					...
					'is_iva_enabled' => (bool) $getSupplierDetails[0]->is_iva_enabled,
					'iva_value' => ($getSupplierDetails[0]->iva_value) + 0,
					'is_retencion_enabled' => (bool) $getSupplierDetails[0]->is_retencion_enabled,
					'retencion_value' => ($getSupplierDetails[0]->retencion_value) + 0,
					'is_reteica_enabled' => (bool) $getSupplierDetails[0]->is_reteica_enabled,
					'reteica_value' => ($getSupplierDetails[0]->reteica_value) + 0,
					'is_iva_provider_enabled' => (bool) $getSupplierDetails[0]->is_iva_provider_enabled,
					'iva_provider_value' => ($getSupplierDetails[0]->iva_provider_value) + 0,
					'is_retencion_provider_enabled' => (bool) $getSupplierDetails[0]->is_retencion_provider_enabled,
					'retencion_provider_value' => ($getSupplierDetails[0]->retencion_provider_value) + 0,
					'is_reteica_provider_enabled' => (bool) $getSupplierDetails[0]->is_reteica_provider_enabled,
					'reteica_provider_value' => ($getSupplierDetails[0]->reteica_provider_value) + 0,
			...
			if (!empty($session)) {
				...
				if ($this->input->post('action_type') == 'add') {
					...
					$dataSupplier = array(
						...
						"is_iva_enabled" => $is_supplier_iva_enabled, "iva_value" => $supplier_iva_value,
						"is_retencion_enabled" => $is_supplier_retention_enabled, "retencion_value" => $supplier_retention_value,
						"is_reteica_enabled" => $is_supplier_retica_enabled, "reteica_value" => $supplier_retica_value,
						"is_iva_provider_enabled" => $is_provider_iva_enabled, "iva_provider_value" => $provider_iva_value,
						"is_retencion_provider_enabled" => $is_provider_retention_enabled, "retencion_provider_value" => $provider_retention_value,
						"is_reteica_provider_enabled" => $is_provider_retica_enabled, "reteica_provider_value" => $provider_retica_value,
					...
					$updateSupplier = $this->Master_model->update_supplier($dataSupplier, $supplier_id);
