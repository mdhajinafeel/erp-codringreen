            ...
            if (!empty($session)) {
                ...
                if (count($exportOrderDetail) == 1) {
                    ...
                    if ($originId == 3) {
                        ...
                        $objSheet->SetCellValue("A6", $this->lang->line("bl_number"));
                        ...
                        $objSheet->SetCellValue("E17", strtoupper($this->lang->line("length")));

                        if ($measurementSystemId == 7) {
                            $objSheet->SetCellValue("F17", strtoupper($this->lang->line("gross_volume")));
                            $objSheet->SetCellValue("G17", strtoupper($this->lang->line("net_volume")));
                        } else if ($measurementSystemId == 8) {
                            $objSheet->SetCellValue("F17", strtoupper($this->lang->line("gross_weight")));
                            $objSheet->SetCellValue("G17", strtoupper($this->lang->line("net_weight")));
                        }

                        $objSheet->SetCellValue("H17", strtoupper($this->lang->line("pieces")));
                        $objSheet->SetCellValue("I17", strtoupper($this->lang->line("average_log_weight")));

                        $objSheet->getStyle("A17:I17")->getFont()->setBold(true);
                        $objSheet->getStyle("A17:I17")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("C4D79B");
                        $objSheet->getStyle("A17:I17")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        $objSheet->getStyle("A17:I17")->applyFromArray($styleArray);
                        ...
                        if (count($getContainerDetails) > 0) {
                            foreach ($getContainerDetails as $containerdetails) {
                                ...
                                $objSheet->SetCellValue("E$summaryDataCount", html_entity_decode($containerdetails->length_text, ENT_QUOTES, 'UTF-8'));
                                ...
                                if ($measurementSystemId == 7) {
                                    $objSheet->SetCellValue("F$summaryDataCount", ($containerdetails->total_gross_volume + 0));
                                    $objSheet->SetCellValue("G$summaryDataCount", ($containerdetails->total_volume + 0));
                                } else if ($measurementSystemId == 8) {
                                    $objSheet->SetCellValue("F$summaryDataCount", ($containerdetails->metric_ton + 0));
                                    $objSheet->SetCellValue("G$summaryDataCount", ($containerdetails->metric_ton + 0));
                                }

                                $objSheet->SetCellValue("H$summaryDataCount", $containerdetails->total_pieces);

                                $objSheet->SetCellValue("I$summaryDataCount", "=ROUND(G$summaryDataCount*1000/H$summaryDataCount,0)");
                                ...
                                $objSheet->getStyle("I$summaryDataCount")->getNumberFormat()->setFormatCode('_(* #,##0_);_(* (#,##0);_(* "-"??_);_(@_)');
                        ...
                        $objSheet->getStyle("A18:I$lastRowSummary")->applyFromArray($styleArray);
                        $objSheet->getStyle("A18:I$lastRowSummary")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        ...
                        $objSheet->getStyle("A$summaryDataCount:I$summaryDataCount")->getFont()->setBold(true);
                        $objSheet->getStyle("A$summaryDataCount:I$summaryDataCount")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("C4D79B");
                        $objSheet->getStyle("A$summaryDataCount:I$summaryDataCount")->applyFromArray($styleArray);
                        ...
                        $objSheet->getStyle("A$summaryDataCount:I$summaryDataCount")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        ...
                        $objSheet->SetCellValue("K$analysisRowDataCount", $this->lang->line("text_container_count"));
                        $objSheet->getStyle("K$analysisRowDataCount")->getFont()->setBold(true);
                        $objSheet->getStyle("K$analysisRowDataCount")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("F2DCDB");
                        $objSheet->getStyle("K$analysisRowDataCount")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

                        $analysisRowDataCount++;
                        foreach ($diameterHeaderArr as $diameter) {
                            $objSheet->SetCellValue("K$analysisRowDataCount", "$diameter");
                            ...
                            $analysisColumnDataCount = "L";
                            foreach ($lengthHeaderArr as $length) {
                                $objSheet->SetCellValue("$analysisColumnDataCount$analysisRowDataCount", "=COUNTIFS(D17:D$lastRowSummary,K$analysisRowDataCount,E17:E$lastRowSummary,$analysisColumnDataCount$analysisHeaderCount)");
                                $analysisColumnDataCount++;
                            }
                        ...
                        $analysisColumnDataCount = $this->decrementLetter($analysisColumnDataCount);
                        $analysisRowDataCount = $analysisRowDataCount - 1;
                        $objSheet->getStyle("K17:$analysisColumnDataCount$analysisRowDataCount")->applyFromArray($styleArray);
                        ...
                        $objSheet->SetCellValue("K$analysisRowDataCount", $this->lang->line("text_weight_count"));
                        $objSheet->getStyle("K$analysisRowDataCount")->getFont()->setBold(true);
                        $objSheet->getStyle("K$analysisRowDataCount")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("F2DCDB");
                        $objSheet->getStyle("K$analysisRowDataCount")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        ...
                        foreach ($diameterHeaderArr as $diameter) {
                            ...
                            foreach ($lengthHeaderArr as $length) {
                                ...
                                $objSheet->SetCellValue("$analysisColumnDataCount$analysisRowDataCount", "=SUMIFS(G17:G$lastRowSummary,D17:D$lastRowSummary,K$analysisRowDataCount,E17:E$lastRowSummary,$analysisColumnDataCount$analysisHeaderCount)");
                        ...
                        $analysisRowDataCount = $analysisRowDataCount - 1;
                        $analysisColumnDataCount = $this->decrementLetter($analysisColumnDataCount);
                        $objSheet->getStyle("K$analysisHeaderCount:$analysisColumnDataCount$analysisRowDataCount")->applyFromArray($styleArray);
                        ...
                        $objSheet->mergeCells("K$analysisHeaderCount:K$analysisRowDataCount");
                        $objSheet->SetCellValue("K$analysisHeaderCount", $this->lang->line("text_wt_var_report"));
                        $objSheet->getStyle("K$analysisHeaderCount")->getFont()->setBold(true);
                        $objSheet->getStyle("K$analysisHeaderCount")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB("F2DCDB");
                        $objSheet->getStyle("K$analysisHeaderCount")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER)->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)->setWrapText(true);
                        ...
                        foreach ($diameterHeaderArr as $diameter) {
                            ...
                            foreach ($lengthHeaderArr as $length) {
                               ...
                               // $objSheet->SetCellValue("$analysisColumnDataCount$analysisRowDataCount", "=MIN(IF(D18:D22=K$analysisRowDataCount, I18:I22))");
                                ...
                                $analysisColumnDataCount++;
                                $objSheet->SetCellValue("$analysisColumnDataCount$analysisRowDataCount", "=IFERROR(AVERAGEIFS(I18:I$lastRowSummary,D18:D$lastRowSummary,K$analysisRowDataCount,E18:E$lastRowSummary,$calcRowCount$analysisHeaderCount), 0)");
                                $objSheet->getStyle("$analysisColumnDataCount$analysisRowDataCount")->getNumberFormat()->setFormatCode('_(* #,##0_);_(* (#,##0);_(* "-"??_);_(@_)');
