            ...
            if (!empty($session)) {
                ...
                if (count($getReceptionDetails) == 1 && count($getReceptionDataDetails) > 0) {
                    ...
                    foreach ($getFormulae as $formula) {
                        ...
                        if ($formula->context == "CBM_HOPPUS_GROSSVOLUME" || $formula->context == "CBM_GEO_GROSSVOLUME") {
                        ...
                        if ($formula->context == "CBM_HOPPUS_NETVOLUME" || $formula->context == "CBM_GEO_NETVOLUME") {
                    ...
                    if ($getReceptionDetails[0]->product_id == 2 && ($getReceptionDetails[0]->measurementsystem_id == 1 || $getReceptionDetails[0]->measurementsystem_id == 4)) {
                        ...
                        $objSheet->SetCellValue("C$rowCount", $this->lang->line('thickness') . ' ' . $this->lang->line('inch'));
                        $objSheet->SetCellValue("D$rowCount", $this->lang->line("pieces"));
                        $objSheet->SetCellValue("E$rowCount", $this->lang->line("volume_pie"));
                        $objSheet->SetCellValue("F$rowCount", $this->lang->line("face"));
                        $objSheet->SetCellValue("G$rowCount", $this->lang->line("gross_volume"));
                        $objSheet->SetCellValue("H$rowCount", $this->lang->line("net_volume"));
                        $objSheet->SetCellValue("I$rowCount", $this->lang->line("remaining_pieces"));
                        $objSheet->SetCellValue("J$rowCount", $this->lang->line("gross_volume"));
                        $objSheet->SetCellValue("K$rowCount", $this->lang->line("net_volume"));
                        $objSheet->SetCellValue("L$rowCount", $this->lang->line("dispatched_containers"));
                        ...
                        $objSheet->getStyle("A$rowCount:L$rowCountData")->applyFromArray($styleArray);

                        $objSheet->SetCellValue("D3", "=SUM(D9:D$rowCountData)");
                        $objSheet->SetCellValue("D4", "=SUM(H9:H$rowCountData)");
                        $objSheet->SetCellValue("D5", "=SUM(I9:I$rowCountData)");
                        $objSheet->SetCellValue("D6", "=SUM(K9:K$rowCountData)");
                        ...
                        $objSheet->getColumnDimension("L")->setAutoSize(false)->setWidth(40);
                            ...
                            || $getReceptionDetails[0]->measurementsystem_id == 5 || $getReceptionDetails[0]->measurementsystem_id == 6) {
